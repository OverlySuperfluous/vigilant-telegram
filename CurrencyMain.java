			...
			public void actionPerformed(ActionEvent e)
			 {
				try
				{
					lblResult_1.setText("Result: " + DistanceConversion.convertWithPrecision(comboBox_2.getSelectedIndex(), comboBox_3.getSelectedIndex(), Float.tryParse(textField.getText()), 2));
				}
				catch (Exception e)
				{
					JOptionPane.showMessageDialog(null, "That is not a valid number. Please enter a valid number.", "InfoBox: " + "Error!", JOptionPane.INFORMATION_MESSAGE);
